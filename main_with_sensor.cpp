...
void main_ethernet_inside_while(){
struct pbuf* p = NULL;
...
void main_temperature_sensor_inside_while(One_wire one_wire,rom_address_t address){
...
int main()
{
	...
	while (true) {
		main_ethernet_inside_while();
		main_temperature_sensor_inside_while(one_wire, address);	
	}
}
